...
data = r'\\antwerpen.local\Doc\OD_IF_AUD\2_04_Statistiek\2_04_01_Data_en_kaarten\
01_Stad_deelgebieden\statistische_sectoren_buurten\sector_wijkgrens'
bg_statsec = shapefile.Reader(data + r'\sectoren_gesplitst.shp')
...
* voorbeeld: haal een bestand op en aggregeer het naar unieke x-y coördinaten. 
* Zorg dat je polygonen en je punten in hetzelfde projectiesysteem zitten!.
